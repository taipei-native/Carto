...
namespace Carto.IO
{
    ...
    public static class GeoTiff
    {
        ...
        */
        ...
        public static void Write(Options options, RasterKind rasterKind, WriteGridMethod writeGridMethod, Action<string, int> onReportMethod, List<string> writtenFileList)
        {
