...
<qgis version="3.28.8-Firenze" labelsEnabled="1" styleCategories="LayerConfiguration|Symbology|Labeling" readOnly="0">
  ...
  <labeling type="rule-based">
    <rules key="{283a0737-998f-4900-bf90-2c2acc898170}">
      ...
      <rule scalemaxdenom="15000" description="Goverment" key="{a7c50684-fd1a-44c9-bb73-9cbdf53c42ae}" scalemindenom="1" filter="&quot;Category&quot; ~ 'Admin|Education|Police|Post(?!Box)'">
        <settings calloutType="simple">
      ...
      <rule key="{54a4655a-1337-4205-9831-991718efc2d8}" filter="ELSE">
        <settings calloutType="simple">
