...
<qgis readOnly="0" labelsEnabled="1" version="3.28.8-Firenze" styleCategories="LayerConfiguration|Symbology|Labeling">
  ...
  <labeling type="rule-based">
    <rules key="{d27ace19-dd10-4f83-93cc-0e040dd12db8}">
      <rule key="{86cf6b78-a79e-4f2f-bbf1-ce04888186ae}" scalemindenom="1" description="Roads" scalemaxdenom="10000" filter="&quot;Category&quot; ~ 'Highway|Large|Medium|Small'">
        <settings calloutType="simple">
          <text-style fontLetterSpacing="0" blendMode="0" allowHtml="0" capitalization="0" isExpression="0" fontItalic="0" textColor="150,150,150,255" fontWeight="75" fontWordSpacing="0" multilineHeight="1" forcedItalic="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="4" fontStrikeout="0" previewBkgrdColor="255,255,255,255" useSubstitutions="0" textOpacity="1" legendString="Aa" fontSizeUnit="RenderMetersInMapUnits" fontKerning="1" namedStyle="Bold" textOrientation="horizontal" fieldName="Name" forcedBold="0" fontUnderline="0" multilineHeightUnit="Percentage" fontFamily="Microsoft JhengHei UI">
            <families/>
